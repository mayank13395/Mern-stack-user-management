...
// @desc  update user
// @access Private
exports.userRouters.post('/update-user-info', authentication_1.default, get_user_1.default);
// @route POST /update-profile-pic
// @desc  update user profile pic
// @access Private
exports.userRouters.get('/update-profile-pic', authentication_1.default, update_profile_pic_1.default);
